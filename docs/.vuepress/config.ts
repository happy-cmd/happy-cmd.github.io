...
const DOMAIN_NAME = 'happy_cmd.github.io' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'happy-cmd/happy-cmd.github.io', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'wenxin', // 必需
      link: 'https://github.com/happy-cmd', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://wxcui.top/wordpress/wp-content/uploads/2021/04/112-1024x751.png',
      name: '何以闻新',
      slogan: '真实而热切地活着~',
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:jiahcui@stu.xidian.edu.cn',
        },
      ],
    },
    ...
    extendFrontmatter: {
      author: {
        name: 'wenxin',
        link: 'https://github.com/happy-cmd'
      }
    },
